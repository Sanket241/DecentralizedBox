...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4 sm:p-6">
      <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-center">About DecentralizedBox</h1>
      
      <section className="max-w-4xl text-center mb-4 sm:mb-6">
      ...
      <section className="max-w-4xl text-center mb-4 sm:mb-6">
        ...
        <ul className="list-disc list-inside text-left text-base sm:text-lg leading-relaxed mx-auto max-w-md">
